 ...
 * Integer: The integer value 5 is a numeric value that
 * can be used in calculations, comparisons, and other operations.
 ...
 * to the integer i to get the ASCII value of the
